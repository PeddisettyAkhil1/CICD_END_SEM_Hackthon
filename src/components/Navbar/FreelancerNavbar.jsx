    ...
    <>
      <header className="flex h-[80px] justify-between items-center px-3 z-2 fixed top-0 left-0 right-0 bg-white">
        ...
        <nav className="hidden md:flex items-center gap-x-7 ml-5">
          ...
          <Link to="/freelancer/dashboard" className="px-2 hover:border-b-[3px] hover:border-red-500 hover:rounded-bl-[5px] hover:rounded-br-[5px]">DASHBOARD</Link>

          <Link to="/freelancer/orders" className="px-2 hover:border-b-[3px] hover:border-red-500 hover:rounded-bl-[5px] hover:rounded-br-[5px]">ORDERS</Link>
          ...
          transition-all duration-[150ms] ease-in-out"><FaPowerOff className="translate-y-[2px] text-[18px]"/>LOGOUT</button>
